  ...
  <section className='relative'>
   ...
   {[...Array(2)].map((arr) => (
            <div
              ...
              {CLIENTS.map((client) => (
                <div key={client.alt} className=" relative w-[150px] m-20 shrink-0 flex items-center">
  ...
  <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
      ...
      <section className="relative">
        ...
        <div className="mt-20 px-4 sm:px-6  flex flex-col overflow-x-hidden overflow-visible">
          ...
          <TitleSection title="Trusted by all" subheading="Join thousands of satisfied users who rely on our platform for their  personal and professional productivity needs." pill="Testimonials"/>
          {[...Array(2)].map((arr, index) => (
            <div key={randomUUID()} className={twMerge(   clsx('mt-10 flex flex-nowrap gap-6 self-start', { 'flex-row-reverse': index === 1, 'animate-[slide_250s_linear_infinite]': true, 'animate-[slide_250s_linear_infinite_reverse]': index === 1, 'ml-[100vw]': index === 1,}),'hover:paused')}>
              {USERS.map((testimonial, index) => (
                <CustomCard key={testimonial.name} className="w-[500px] shrink-0s rounded-xl dark:bg-gradient-to-t dark:from-border dark:to-background"
                  cardHeader={
            ...
            <CustomCard
              ...
              cardContent={
                <CardContent className="p-0">
                  ...
                  <Button
                    variant="btn-primary"
                    className="whitespace-nowrap w-full mt-4 white"
                  >
                    {card.planType === PRICING_PLANS.proplan
                      ? 'Go Pro'
                      : 'Get Started'}
